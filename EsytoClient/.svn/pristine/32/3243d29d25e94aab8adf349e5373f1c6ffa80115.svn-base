 ...
 */
package com.ec2.yspay.zxing.camera;
...
import com.ec2.yspay.common.ScreenParams;
...
//		}
		ScreenParams params = ScreenParams.getInstance((Activity)context);
		point.x = params.screenWidth;
		point.y = params.screenHeight;
		return point;
	}
