 ...
 * @since  [产品/模块版本]
 */
public class AddFeedbackTask extends BaseTask
{
    private static final String url_left = "/app/feedback/add";
    private BooleanResponse response;
    private String content;
    /** 
     * <默认构造函数>
     */
    public AddFeedbackTask(Context context,String content)
    {
        super(context);
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("reqSource",1);
        request.addParam("version",Toolkits.getCurAppVerName(mContext));
        return request;
    }
}
