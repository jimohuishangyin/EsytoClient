...
public class HalfRoundImageView extends ImageView { 
    ...
    public HalfRoundImageView(Context context, AttributeSet attrs, int defStyle) { 
...
//        canvas.drawCircle(defaultWidth / 2, defaultHeight / 2, radius, paint); 
        RectF oval2 = new RectF(defaultWidth / 2 - radius, defaultHeight / 2 - radius, defaultWidth/2 + radius , defaultHeight/2 + radius);// 设置个新的长方形，扫描测量  
