 ...
 * @since  [产品/模块版本]
 */
public class CloseOrderTask extends BaseTask
{
    private static final String url_left = "/app/trans";
    private CloseOrderResponse response;
    private String orderId;
    /** 
     * <默认构造函数>
     */
    public CloseOrderTask(Context context,String orderId)
    {
        super(context);
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("request_type","6604");
