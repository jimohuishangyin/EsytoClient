 ...
 * @since  [产品/模块版本]
 */
public class PrintDetailTask extends BaseTask
{
    private static final String url_left = "/app/dayPosDetail";
    private PrintDetailResponse response;
    /** 
     * <默认构造函数>
     */
    public PrintDetailTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new PrintDetailResponse();
