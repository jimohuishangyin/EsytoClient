 ...
 * @since  [产品/模块版本]
 */
public class ValidSmsCoceTask extends BaseTask
{
    private static final String url_left = "/service/sms/validate";
    private ValidSmsCoceResponse response;
    private String sessionId;
    private String smsCode;
    /** 
     * <默认构造函数>
     */
    public ValidSmsCoceTask(Context context,String sessionId,String smsCode)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new ValidSmsCoceResponse();
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("sessionId",sessionId);
