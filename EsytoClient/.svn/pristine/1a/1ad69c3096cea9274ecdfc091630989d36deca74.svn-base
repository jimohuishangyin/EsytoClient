 ...
 * @since  [产品/模块版本]
 */
public class ReportUserDefinedFormTask extends BaseTask
{
    private static final String url_left = "/app/pos/customReportForm";
     ...
     * <默认构造函数>
     */
    public ReportUserDefinedFormTask(Context context,String beginTime,String endTime)
    {
        super(context);
