 ...
 * @since  [产品/模块版本]
 */
public class AddStaffTask extends BaseTask
{
    private static final String url_left = "/app/account/addAccount";
     ...
     * <默认构造函数>
     */
    public AddStaffTask(Context context,String userName,String shopCode,String account,String duty,boolean isSendSms)
    {
        super(context);
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("isSendSms",isSendSms);
        return request;
    }
}
