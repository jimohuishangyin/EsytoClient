 ...
 * @since  [产品/模块版本]
 */
public class GetMainPayStateTask extends BaseTask
{
    private static final String url_left = "/app/pos/payStatResult";
    private GetMainPayStateResponse response;
    /** 
     * <默认构造函数>
     */
    public GetMainPayStateTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new GetMainPayStateResponse();
