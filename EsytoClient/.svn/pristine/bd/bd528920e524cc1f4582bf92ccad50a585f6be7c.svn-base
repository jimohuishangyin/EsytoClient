 ...
 * @since  [产品/模块版本]
 */
public class ReportStaffTask extends BaseTask
{
    private static final String url_left = "/app/pos/accountReportDetails";
     ...
     * <默认构造函数>
     */
    public ReportStaffTask(Context context,String account)
    {
        super(context);
