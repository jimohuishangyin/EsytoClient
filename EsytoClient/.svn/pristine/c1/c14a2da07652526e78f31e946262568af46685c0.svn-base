 ...
 * @since  [产品/模块版本]
 */
public class GetBankCardPosTask extends BaseTask
{
    private String url_left = "/app/pos/queryBankCardPos";
    private GetBankCardPosResponse response;
    private int pageNow;
    /** 
     * <默认构造函数>
     */
    public GetBankCardPosTask(Context context,int pageNow,boolean isCeXiao)
    {
        super(context);
        ...
        if(!isCeXiao){
            url_left = "/app/pos/queryThirdPartyPos";
        }
    }
    /**
     * 重载方法
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new GetBankCardPosResponse();
