...
{
    private static final String url_left = "/app/account/resetPass";
     ...
     * <默认构造函数>
     */
    public ReSetPasswordTask(Context context,String userName,String userPwd)
    {
        super(context);
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("new_pass",userPwd);
        return request;
    }
}
