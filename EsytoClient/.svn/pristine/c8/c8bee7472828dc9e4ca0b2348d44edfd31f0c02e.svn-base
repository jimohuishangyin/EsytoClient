 ...
 * @since  [产品/模块版本]
 */
public class PrintLinearLayoutButton extends LinearLayout{
	...
	public PrintLinearLayoutButton(Context context){
		super(context);
		this.context = context;
        control();
	}
	public PrintLinearLayoutButton(Context context, AttributeSet attrs, int defStyleAttr) {
		this(context, attrs);
		// TODO Auto-generated constructor stub
	}
	public PrintLinearLayoutButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = context;
		control();
            ...
            public boolean onTouch(View v, MotionEvent mEvent)
            {
                ...
                switch (v.getId()) {  
                    ...
                    if(mEvent.getAction() == MotionEvent.ACTION_DOWN) {  
                        y1 = mEvent.getY(); 
                        llParent.setBackgroundColor(getResources().getColor(R.color.gray_pressed));
...
//                            Toast.makeText(context, "222222", 2).show();
    ...
    private void initView(){
        View view= LayoutInflater.from(context).inflate(R.layout.widget_llbtn_print, null);
