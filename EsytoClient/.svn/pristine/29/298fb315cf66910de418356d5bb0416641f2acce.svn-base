 ...
 * @since  [产品/模块版本]
 */
public class GetShopListTask extends BaseTask
{
    private static final String url_left = "/app/shop/query";
    private GetShopListResponse response;
    /** 
     * <默认构造函数>
     */
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new GetShopListResponse();
