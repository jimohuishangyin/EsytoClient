 ...
 * @since  [产品/模块版本]
 */
public class BatchSendSmsTask extends BaseTask
{
    private static final String url_left = "/app/account/batchSendSms";
    private String mobiles;
    private BooleanResponse response;
    /** 
     * <默认构造函数>
     */
    public BatchSendSmsTask(Context context,String mobiles)
    {
        super(context);
    ...
    private ClientRequest getRequest(){
        ...
        try
        {
            request.addParam("mobiles", mobiles);
        }
        catch (Exception e)
        {
