...
import com.ec2.yspay.test.lhx.TestUnionPayActivity;
...
//		timeselector1.showMenu();
    ...
    private void initGroupInfoList() {
        ...
        groupInfo.mChildList.add(new ItemInfo("意见反馈",
                new CallBackForTest() {
                    @Override
                    public void execute() {
                        TestInterface testInterface =  new TestInterface(mContext);
                        testInterface.feedbackTest();
                    }
                }));
        ...
        groupInfo = new GroupInfo("测试，银行卡");
        mGroupList.add(groupInfo);
        groupInfo.mChildList.add(new ItemInfo("一键收款",
                new CallBackForTest() {
                    @Override
                    public void execute() {
                    	Intent payIntent = new Intent(mContext, TestUnionPayActivity.class);
