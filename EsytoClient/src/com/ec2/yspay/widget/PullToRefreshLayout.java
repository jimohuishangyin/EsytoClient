...
public class PullToRefreshLayout extends RelativeLayout
{
    ...
    //是否可以下拉刷新
    private boolean isPullDownAble = true;
    //是否可以上拉加载更多
    private boolean isPullUpAble = true;
    ...
    {
        canPullDown = isPullDownAble;
        canPullUp = isPullUpAble;
    }
