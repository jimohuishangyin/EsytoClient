 ...
 * @since  [产品/模块版本]
 */
public class ButtonRedCenter extends LinearLayout{
	...
	public ButtonRedCenter(Context context){
		super(context);
		this.context = context;
        control();
	}
	public ButtonRedCenter(Context context, AttributeSet attrs, int defStyleAttr) {
		this(context, attrs);
		// TODO Auto-generated constructor stub
	}
	public ButtonRedCenter(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = context;
		control();
            ...
            public boolean onTouch(View v, MotionEvent mEvent)
            {
                ...
                switch (v.getId()) {  
                    ...
                    if(mEvent.getAction() == MotionEvent.ACTION_DOWN) {  
                        y1 = mEvent.getY(); 
                        llParent.setBackgroundResource(R.drawable.red_long_btn_over636_144);
...
//                        llParent.setBackgroundResource(R.drawable.tkcx_bg948_144);
                        llParent.setBackgroundResource(R.drawable.red_long_btn_normal636_144);
...
//                            Toast.makeText(context, "222222", 2).show();
    ...
    private void initView(){
        View view= LayoutInflater.from(context).inflate(R.layout.widget_button_red_center, null);
