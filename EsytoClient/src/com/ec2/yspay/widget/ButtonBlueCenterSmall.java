 ...
 * @since  [产品/模块版本]
 */
public class ButtonBlueCenterSmall extends LinearLayout{
	...
	public ButtonBlueCenterSmall(Context context){
		super(context);
		this.context = context;
        control();
	}
	public ButtonBlueCenterSmall(Context context, AttributeSet attrs, int defStyleAttr) {
		this(context, attrs);
		// TODO Auto-generated constructor stub
	}
	public ButtonBlueCenterSmall(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		this.context = context;
		control();
            ...
            public boolean onTouch(View v, MotionEvent mEvent)
            {
                ...
                switch (v.getId()) {  
                    ...
                    if(mEvent.getAction() == MotionEvent.ACTION_DOWN) {  
                        y1 = mEvent.getY(); 
                        llParent.setBackgroundResource(R.drawable.openwinbtn_over);
...
//                        llParent.setBackgroundResource(R.drawable.tkcx_bg948_144);
                        llParent.setBackgroundResource(R.drawable.openwinbtn_normal);
...
//                            Toast.makeText(context, "222222", 2).show();
    ...
    private void initView(){
        View view= LayoutInflater.from(context).inflate(R.layout.widget_button_blue_center_small, null);
        llParent =(RelativeLayout)view.findViewById(R.id.ll_parent);
        ivIcon =(ImageView)view.findViewById(R.id.iv_icon);
        tvTitle =(TextView)view.findViewById(R.id.tv_content);
        LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);//45dp
        params.setMargins(0, 0, 0, 0);
        addView(view, params);
        setPadding(Toolkits.dip2px(context, 15), 0, Toolkits.dip2px(context, 15), 0);
    }
    /**
     * @Description: 设置标题文字
     * @author   罗洪祥
