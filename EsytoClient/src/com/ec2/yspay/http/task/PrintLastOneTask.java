 ...
 * @since  [产品/模块版本]
 */
public class PrintLastOneTask extends BaseTask
{
    private static final String url_left = "/app/reprint";
    private PrintLastOneResponse response;
    /** 
     * <默认构造函数>
     */
    public PrintLastOneTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new PrintLastOneResponse();
