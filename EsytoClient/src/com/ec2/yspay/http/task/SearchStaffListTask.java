 ...
 * @since  [产品/模块版本]
 */
public class SearchStaffListTask extends BaseTask
{
    private static final String url_left = "/app/account/serchAccount";
    private SearchStaffListResponse response;
    private String keyWord="";
    /** 
     * <默认构造函数>
     */
    public SearchStaffListTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new SearchStaffListResponse();
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("key_word", keyWord);
        return request;
    }
    /**
     * 获取 keyWord
