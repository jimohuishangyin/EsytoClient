 ...
 * @since  [产品/模块版本]
 */
public class PrintByOrderidTask extends BaseTask
{
    private static final String url_left = "/app/printByOrderId";
    private String orderId;
    private PrintByOrderidResponse response;
    /** 
     * <默认构造函数>
     */
    public PrintByOrderidTask(Context context,String orderId)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new PrintByOrderidResponse();
