 ...
 * @since  [产品/模块版本]
 */
public class SettleAccountsTask extends BaseTask
{
    private static final String url_left = "/app/clearCheck";
    private PrintDayAllResponse response;
    /** 
     * <默认构造函数>
     */
    public SettleAccountsTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new PrintDayAllResponse();
