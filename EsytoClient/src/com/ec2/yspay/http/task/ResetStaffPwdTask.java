 ...
 * @since  [产品/模块版本]
 */
public class ResetStaffPwdTask extends BaseTask
{
    private static final String url_left = "/app/account/resetPassToAdmin";
     ...
     * <默认构造函数>
     */
    public ResetStaffPwdTask(Context context)
    {
        super(context);
