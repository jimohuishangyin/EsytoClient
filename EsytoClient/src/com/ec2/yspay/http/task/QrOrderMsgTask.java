 ...
 * @since  [产品/模块版本]
 */
public class QrOrderMsgTask extends BaseTask
{
    private static final String url_left = "/app/pos/queryOrder";
    private QrOrderMsgResponse response;
    private String orderId;
    /** 
     * <默认构造函数>
     */
    public QrOrderMsgTask(Context context,String orderId)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new QrOrderMsgResponse();
