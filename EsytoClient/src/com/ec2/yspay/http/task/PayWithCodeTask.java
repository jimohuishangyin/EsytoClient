 ...
 * @since  [产品/模块版本]
 */
public class PayWithCodeTask extends BaseTask
{
    private static final String url_left = "/app/trans";
    private PayWithCodeResponse response;
     ...
     * <默认构造函数>
     */
    public PayWithCodeTask(Context context,int payType,OrderInfo orderInfo,String authCode,String remark)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new PayWithCodeResponse();
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("request_type","6602");
