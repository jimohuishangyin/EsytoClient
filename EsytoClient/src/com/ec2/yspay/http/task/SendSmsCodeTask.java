 ...
 * @since  [产品/模块版本]
 */
public class SendSmsCodeTask extends BaseTask
{
    private static final String url_left = "/service/sms/send";
    private SendSmsCodeResponse response;
    private String userName;
    private String codeType;
    public final static String TYPE_REGISTER="0";

    public final static String TYPE_RESET_PASSWORD="1";
    /** 
     * <默认构造函数>
     */
    public SendSmsCodeTask(Context context,String userName,String codeType)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new SendSmsCodeResponse();
    ...
    private ClientRequest getRequest(){
        ...
        request.addParam("operType",codeType);
        return request;
    }
}
