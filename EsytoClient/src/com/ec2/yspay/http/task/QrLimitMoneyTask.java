 ...
 * @since  [产品/模块版本]
 */
public class QrLimitMoneyTask extends BaseTask
{
    private static final String url_left = "/app/quotaList";
    private QrLimitMoneyResponse response;
    /** 
     * <默认构造函数>
     */
    public QrLimitMoneyTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new QrLimitMoneyResponse();
