 ...
 * @since  [产品/模块版本]
 */
public class GetOrderListAllTask extends BaseTask
{
    private static final String url_left = "/app/dayPosList";
    private GetOrderListAllResponse response;
    /** 
     * <默认构造函数>
     */
    public GetOrderListAllTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new GetOrderListAllResponse();
