 ...
 * @since  [产品/模块版本]
 */
public class CheckManagerPwdTask extends BaseTask
{
    private static final String url_left = "/app/pay/checkPass";
    private CheckManagerPwdResponse response;
    private String password;
    /** 
     * <默认构造函数>
     */
    public CheckManagerPwdTask(Context context,String password)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new CheckManagerPwdResponse();
