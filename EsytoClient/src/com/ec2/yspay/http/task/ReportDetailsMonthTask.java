 ...
 * @since  [产品/模块版本]
 */
public class ReportDetailsMonthTask extends BaseTask
{
    private static final String url_left = "/app/pos/monthReportDetails";
     ...
     * <默认构造函数>
     */
    public ReportDetailsMonthTask(Context context,String date)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new ReportDetailsResponse();
