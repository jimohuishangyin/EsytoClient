 ...
 * @since  [产品/模块版本]
 */
public class GetPosOrderIdTask extends BaseTask
{
    private static final String url_left = "/app/pos/applyOrderNo";
    private GetPosOrderIdResponse response;
    /** 
     * <默认构造函数>
     */
    public GetPosOrderIdTask(Context context)
    {
        super(context);
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        response = new GetPosOrderIdResponse();
