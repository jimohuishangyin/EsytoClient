 ...
 * @since  [产品/模块版本]
 */
public class ReportStaffFormTask extends BaseTask
{
    private static final String url_left = "/app/pos/accountReportForm";
    private ReportFormResponse response;
    private String account;
    /** 
     * <默认构造函数>
     */
    public ReportStaffFormTask(Context context,String account)
    {
        super(context);
