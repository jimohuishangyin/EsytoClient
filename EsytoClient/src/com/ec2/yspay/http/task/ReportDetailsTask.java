 ...
 * @since  [产品/模块版本]
 */
public class ReportDetailsTask extends BaseTask
{
    private static final String url_left = "/app/pos/dayReportDetails";
     ...
     * <默认构造函数>
     */
    public ReportDetailsTask(Context context,String date)
    {
        super(context);
