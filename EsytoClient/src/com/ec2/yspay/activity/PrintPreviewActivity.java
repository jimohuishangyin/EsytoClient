...
public class PrintPreviewActivity extends BaseActivity {
	...
	private void init(PrintOrderEntity mPrintOrderEntity){
		tvOrderId.setText(mPrintOrderEntity.getOrderId());
		tv_pznum.setText(PayTypeEntity.getPayName(mPrintOrderEntity.getChannelType()));
		tv_money.setText("￥"+mPrintOrderEntity.getAmount());
		tv_remark.setText(mPrintOrderEntity.getRemark());
		tv_time.setText(mPrintOrderEntity.getOrderTime());
		tv_shopname.setText(mPrintOrderEntity.getShopName());
