...
public class PayCashSuccessActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tvYingShou.setText("￥"+intent.getStringExtra("yingshou"));
        tvShiShou.setText("￥"+intent.getStringExtra("shishou"));
        tvZhaoLing.setText("￥"+intent.getStringExtra("zhaoling"));
