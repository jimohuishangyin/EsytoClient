...
public class RegisterActivity extends BaseNoLoginActivity {
	...
	private TextView mSeverDelTextView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCheckBox = (CheckBox) findViewById(R.id.check_image);
		mSeverDelTextView = (TextView) findViewById(R.id.check_del);
		mSeverDelTextView.setOnClickListener(new View.OnClickListener() {
			@Override
